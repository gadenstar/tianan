...
return array(
	...
	'menus' => array(
		array(
			'title' => __('全局设置', 'vp_textdomain'),
			'name' => 'menu_1',
			'icon' => 'font-awesome:fa-magic',
			'menus' => array(
				array(
					'title' => __('基础设置', 'vp_textdomain'),
					'name' => 'submenu_1',
						...
						array(
							...
							'fields' => array(
								array(
									'type' => 'upload',
									'name' => 'logo',
									'label' => __('自定义LOGO', 'vp_textdomain'),
								...
								array(
									'type' => 'select',
									'name' => 'se_teams',
									'label' => __('部门选择', 'vp_textdomain'),
									'description' => __('选择需要显示在首页的部门', 'vp_textdomain'),
									'items' => array(
										'data' => array(
											array(
												'source' => 'function',
								...
								array(
									'type' => 'select',
									'name' => 'se_design',
									'label' => __('设计团队选择', 'vp_textdomain'),
									'description' => __('设计团队选择', 'vp_textdomain'),
									'items' => array(
										'data' => array(
											array(
												'source' => 'function',
								...
								array(
									'type' => 'select',
									'name' => 'se_news',
									'label' => __('分类选择', 'vp_textdomain'),
									'description' => __('选择需要显示在首页的文章分类', 'vp_textdomain'),
									'items' => array(
										'data' => array(
											array(
												'source' => 'function',
